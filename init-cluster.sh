...
rs.initiate({_id:"configRS",configsvr:true,members:[{_id:0,host:"cfg_svr_1:27018"},{_id:1,host:"cfg_svr_2:27019"},{_id:2,host:"cfg_svr_3:27020"}]})
'
...
rs.initiate({_id:"shardParisRS",members:[
  ...
  {_id:2,host:"shardParis_arbiter:27033",arbiterOnly:true}
]})
'
...
rs.initiate({_id:"shardLyonRS",members:[
  ...
  {_id:2,host:"shardLyon_arbiter:27043",arbiterOnly:true}
]})
'
...
# Connexion des shards (mongos) > hash
mongosh --host mongos --port 27017 --eval '
sh.addShard("shardParisRS/shardParis_node1:27031,shardParis_node2:27032")
sh.addShard("shardLyonRS/shardLyon_node1:27041,shardLyon_node2:27042")
